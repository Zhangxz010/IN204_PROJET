...
#include <memory>
#include "../../../include/image/ImageLoader.h"
...
QT_MOC_LITERAL(5, 37, 15), // "loadingFinished"
QT_MOC_LITERAL(6, 53, 13), // "loadingFailed"
QT_MOC_LITERAL(7, 67, 5) // "error"

    },
    "ImageLoader\0imageLoaded\0\0image\0index\0"
    "loadingFinished\0loadingFailed\0error"
};
...
void ImageLoader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->imageLoaded((*reinterpret_cast< const QImage(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        ...
        {
            using _t = void (ImageLoader::*)(const QImage & , int );
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ImageLoader::loadingFinished)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ImageLoader::loadingFailed)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void ImageLoader::imageLoaded(const QImage & _t1, int _t2)
{
...
// SIGNAL 1
void ImageLoader::loadingFinished()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void ImageLoader::loadingFailed(const QString & _t1)
{
